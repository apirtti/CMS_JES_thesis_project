...
if mode>0:
    ...
    if tune==0:
        ...
        f.write('! CMS CP5 tune\n')
        f.write('Tune:pp 14\n')
#        f.write('MultipartonInteractions:pT0Ref=1.41\n')
        f.write('MultipartonInteractions:pT0Ref=1.41\n')
        f.write('MultipartonInteractions:ecmPow=0.03344\n')
        f.write('MultipartonInteractions:bProfile=2\n')
        f.write('MultipartonInteractions:coreRadius=0.7634\n')
        f.write('MultipartonInteractions:coreFraction=0.63\n')
        f.write('ColourReconnection:range=5.176\n')
        f.write('SigmaTotal:zeroAXB=off\n')
        f.write('SpaceShower:alphaSorder=2\n')
        f.write('SpaceShower:alphaSvalue=0.118\n')
        f.write('SigmaProcess:alphaSvalue=0.118\n')
        f.write('SigmaProcess:alphaSorder=2\n')
        f.write('MultipartonInteractions:alphaSvalue=0.118\n')
        f.write('MultipartonInteractions:alphaSorder=2\n')
        f.write('TimeShower:alphaSorder=2\n')
        f.write('TimeShower:alphaSvalue=0.118\n')
        f.write('SigmaTotal:mode=0\n')
        f.write('SigmaTotal:sigmaEl=21.89 \n')
        f.write('SigmaTotal:sigmaTot=100.309\n\n')

    if pdf==0:
        f.write("PDF:pSet = LHAPDF6:cteq6l1\n\n")
#	elif pdf==1:
#		f.write("PDF:pSet = LHAPDF6:NNPDF31_nnlo_as_0118\n\n")
