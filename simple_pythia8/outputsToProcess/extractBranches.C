...
void extractBranches() {
  ...
  //#Events in the file
  cout << "#Events? (1) 1M (2) 500k (3) 100k (4) 10k (5) 1k (6) 3k (7) 30k (8) 300k (9) 10 (10) 5M (11) 10M"
	   << endl;
  temp=-1;	//Reinit
  while (temp<1 || temp >11) cin >> temp;
  ...
  else if (temp==6) n_evts = 3000;
  else if (temp==7) n_evts = 30000;
  else if (temp==8) n_evts = 300000;
  else if (temp==9) n_evts = 10;
  else if (temp==10) n_evts = 5000000;
  else if (temp==11) n_evts = 10000000;
